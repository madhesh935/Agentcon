// Investigative data — Tamil Nadu & Karnataka
...
export const districts = [
  ...
  "Shivamogga", "Tumakuru", "Vijayapura", "Dharwad",
];

export const stateOf: Record<string, "TN" | "KA"> = {
  Chennai: "TN", Coimbatore: "TN", Madurai: "TN", Salem: "TN", Trichy: "TN",
  Tirunelveli: "TN", Vellore: "TN", Erode: "TN", Thanjavur: "TN", Kanyakumari: "TN",
  Bengaluru: "KA", Mysuru: "KA", Mangaluru: "KA", Hubballi: "KA", Belagavi: "KA",
  Kalaburagi: "KA", Shivamogga: "KA", Tumakuru: "KA", Vijayapura: "KA", Dharwad: "KA",
};
...
export const cases: CaseSummary[] = [
  ...
  // ── Karnataka cases ──
  { id: "C-2049", fir: "FIR/2025/BLR/00501", title: "Whitefield IT Park Murder", district: "Bengaluru", status: "Active", severity: "critical", aiConfidence: 91, flagged: true, officer: "Insp. N. Sharma", opened: "2026-04-28", type: "Homicide", victims: 1, suspects: 3, evidence: 29, contradictions: 5 },
  { id: "C-2050", fir: "FIR/2025/MYS/00142", title: "Mysuru Palace Road Robbery", district: "Mysuru", status: "Active", severity: "high", aiConfidence: 68, flagged: true, officer: "Insp. R. Kavitha", opened: "2026-05-02", type: "Robbery", victims: 0, suspects: 2, evidence: 11, contradictions: 1 },
  { id: "C-2051", fir: "FIR/2025/MNG/00089", title: "Mangaluru Port Smuggling", district: "Mangaluru", status: "Review", severity: "high", aiConfidence: 77, flagged: true, officer: "SI P. Bhat", opened: "2026-05-05", type: "Trafficking", victims: 0, suspects: 5, evidence: 22, contradictions: 2 },
  { id: "C-2052", fir: "FIR/2025/HUB/00034", title: "Hubballi Market Assault", district: "Hubballi", status: "Active", severity: "medium", aiConfidence: 55, flagged: false, officer: "Insp. D. Patil", opened: "2026-05-07", type: "Assault", victims: 2, suspects: 1, evidence: 8, contradictions: 0 },
  { id: "C-2053", fir: "FIR/2025/BLG/00211", title: "Belagavi Highway Kidnapping", district: "Belagavi", status: "Active", severity: "critical", aiConfidence: 83, flagged: true, officer: "SI M. Desai", opened: "2026-05-09", type: "Kidnapping", victims: 1, suspects: 3, evidence: 17, contradictions: 3 },
  { id: "C-2054", fir: "FIR/2025/KLB/00055", title: "Kalaburagi Land Dispute Arson", district: "Kalaburagi", status: "Cold", severity: "medium", aiConfidence: 44, flagged: false, officer: "Insp. B. Reddy", opened: "2026-03-25", type: "Arson", victims: 0, suspects: 0, evidence: 5, contradictions: 0 },
  { id: "C-2055", fir: "FIR/2025/SMG/00073", title: "Shivamogga Forest Body", district: "Shivamogga", status: "Review", severity: "high", aiConfidence: 61, flagged: true, officer: "SI T. Gowda", opened: "2026-05-10", type: "Suspicious Death", victims: 1, suspects: 1, evidence: 13, contradictions: 4 },
  { id: "C-2056", fir: "FIR/2025/BLR/00519", title: "Koramangala Cyber Fraud", district: "Bengaluru", status: "Active", severity: "medium", aiConfidence: 72, flagged: true, officer: "Insp. A. Kumar", opened: "2026-05-11", type: "Cyber Crime", victims: 12, suspects: 2, evidence: 31, contradictions: 1 },
];

export const heatmapZones = [
  // Tamil Nadu
  { district: "Chennai",      lat: 13.0827, lng: 80.2707, crimes: 142, risk: 92, officers: 28, state: "TN" },
  { district: "Coimbatore",   lat: 11.0168, lng: 76.9558, crimes: 87,  risk: 71, officers: 19, state: "TN" },
  { district: "Madurai",      lat: 9.9252,  lng: 78.1198, crimes: 64,  risk: 68, officers: 14, state: "TN" },
  { district: "Salem",        lat: 11.6643, lng: 78.1460, crimes: 41,  risk: 52, officers: 9,  state: "TN" },
  { district: "Trichy",       lat: 10.7905, lng: 78.7047, crimes: 53,  risk: 60, officers: 11, state: "TN" },
  { district: "Tirunelveli",  lat: 8.7139,  lng: 77.7567, crimes: 29,  risk: 38, officers: 7,  state: "TN" },
  { district: "Vellore",      lat: 12.9165, lng: 79.1325, crimes: 47,  risk: 64, officers: 10, state: "TN" },
  { district: "Kanyakumari",  lat: 8.0883,  lng: 77.5385, crimes: 18,  risk: 31, officers: 5,  state: "TN" },
  // Karnataka
  { district: "Bengaluru",   lat: 12.9716,  lng: 77.5946, crimes: 198, risk: 95, officers: 34, state: "KA" },
  { district: "Mysuru",      lat: 12.2958,  lng: 76.6394, crimes: 72,  risk: 65, officers: 16, state: "KA" },
  { district: "Mangaluru",   lat: 12.8703,  lng: 74.8425, crimes: 58,  risk: 62, officers: 13, state: "KA" },
  { district: "Hubballi",    lat: 15.3647,  lng: 75.1240, crimes: 44,  risk: 54, officers: 10, state: "KA" },
  { district: "Belagavi",    lat: 15.8497,  lng: 74.4977, crimes: 51,  risk: 59, officers: 11, state: "KA" },
  { district: "Kalaburagi",  lat: 17.3297,  lng: 76.8200, crimes: 33,  risk: 42, officers: 8,  state: "KA" },
  { district: "Shivamogga",  lat: 13.9299,  lng: 75.5681, crimes: 27,  risk: 40, officers: 7,  state: "KA" },
  { district: "Tumakuru",    lat: 13.3409,  lng: 77.1010, crimes: 38,  risk: 49, officers: 9,  state: "KA" },
];
...
export const officers = [
  ...
  // Karnataka
  { id: "O-108", name: "Insp. N. Sharma",  district: "Bengaluru",   cases: 8, online: true  },
  { id: "O-109", name: "Insp. R. Kavitha", district: "Mysuru",      cases: 4, online: true  },
  { id: "O-110", name: "SI P. Bhat",        district: "Mangaluru",   cases: 3, online: false },
  { id: "O-111", name: "Insp. D. Patil",   district: "Hubballi",    cases: 5, online: true  },
  { id: "O-112", name: "SI M. Desai",       district: "Belagavi",    cases: 6, online: true  },
  { id: "O-113", name: "Insp. B. Reddy",   district: "Kalaburagi",  cases: 2, online: false },
  { id: "O-114", name: "SI T. Gowda",       district: "Shivamogga",  cases: 3, online: true  },
  { id: "O-115", name: "Insp. A. Kumar",   district: "Bengaluru",   cases: 7, online: true  },
];
