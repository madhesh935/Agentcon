...
export const Route = createFileRoute("/reports")({
  head: () => ({ meta: [{ title: "Reports — AEGIS" }, { name: "description", content: "Forensic intelligence reports — Tamil Nadu & Karnataka." }] }),
  component: () => {
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                ...
                <span className="font-medium text-foreground">Tamil Nadu &amp; Karnataka</span>.
              </p>
            </div>
            <div className="flex items-center gap-2">
              <Button
              ...
              <div className="glass rounded-xl p-4">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <Badge variant="outline" className="border-border/60">
                    Top {Math.min(10, districtData.length)}
                  </Badge>
                </div>
                <div className="mt-3 h-80">
                  <ResponsiveContainer>
                    <BarChart data={districtData.slice(0, 10)} layout="vertical" margin={{ left: 10 }}>
